...
const UserProfilePage = () => {
  ...
  const handleChangePassword = async(values) => {
    const config = {
        method: "put",
        url: "https://hanu-group-banking-system.herokuapp.com/users/updatePassword",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + getAccessToken(),
        },
          ...
          <Form onSubmit={props.handleSubmit}>
            <div class="row">
              <div class="left col-4">
                ...
                <div onClick={()=> navigate("/user-dashboard")} class="btn btn-secondary btn-lg mx-4">Cancel</div>
              </div>
      ...
      initialValues={{
        ...
        <Form onSubmit={props.handleSubmit}>
            ...
            <div class="row">
                ...
                <div class="right col-4">
                  <label for="exampleInputAddress">New Password</label>
                  <Field
                    id="newPassword"
                    type="password"
                    name="newPassword"
