  ...
  return (
    <div className="vh-100 min-vh-100">
      <div id="mySidenav" className="sidenav">
        ...
        <a href="#" onClick={() => navigate("/admin-transaction")}>
          <i className="fa-solid fa-right-left" /> &nbsp; Transaction
        </a>
        <a href="#" onClick={() => navigate("/admin-customer")}>
          <i className="fa-solid fa-id-card" /> &nbsp;Manage Customer
        </a>

        <a href="#" onClick={() => navigate("/admin-account")}>
        ...
        <div id="main">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              <a href="#" onClick={() => navigate("/admin-profile")}>
