...
_**_Frontend Deployed: https://hanu-group-banking-system-fe.herokuapp.com/_**_
...
When deploy Heroku, App can be crashed because Heap Memory so please reset app when meet this case.
...
We use Spring Boot and MySQL Database.
